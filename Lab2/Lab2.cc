...
main (int argc, char *argv[])
{
  ...
  lteHelper->SetEnbAntennaModelAttribute ("Orientation", DoubleValue (30));
  ...
  MM -> SetPosition(Vector3D(1000,0,1)); // distance between UE and eNodeB is 5 metres
...
// Install and start applications on UE and remote host
 ...
 uint16_t dlPort = 1000;
  ...
  ApplicationContainer onOffApp;
    ...
    onOffHelper.SetAttribute("DataRate", DataRateValue(DataRate("50Mbps"))); //Traffic Bit Rate
