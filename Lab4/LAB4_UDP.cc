...
// Create mobility model with constant positions and deploy all devices in a line with 200m distance between them; Z coordinate for all of them should be 1m!! 
      ...
      positionAlloc->Add (Vector (400.0, 0.0, 1.0));
      positionAlloc->Add (Vector (600.0, 0.0, 1.0));
      positionAlloc->Add (Vector (800.0, 0.0, 1.0));
      positionAlloc->Add (Vector (1000.0, 0.0, 1.0));
...
/////////////////////////////Application part///////////////////////////// 
   ...
   uint16_t dlPort = 1000; //Port number
    ...
    onOffHelper.SetAttribute("PacketSize", UintegerValue(1200)); // Packet size
...
/////////////////////////////PCAP tracing/////////////////////////////   
   ...
   phy.EnablePcap ("WIFI_STA", wifiStaNodes, true);
