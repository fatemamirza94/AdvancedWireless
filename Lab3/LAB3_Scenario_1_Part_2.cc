...
//  phy.Set("CcaMode1Threshold", DoubleValue(-99));
 ...
 /////////////////////////////Deployment///////////////////////////// 
      ...
      positionAlloc->Add (Vector (10.0, 17.32, 1.0));
      positionAlloc->Add (Vector (0.0, 17.32, 1.0));
...
/////////////////////////////Application part///////////////////////////// 
  ...
  Ptr<Socket> recvSink2 = Socket::CreateSocket (stas.Get (3), tid);
  InetSocketAddress local2 = InetSocketAddress (wifiInterfaces.GetAddress (3), dlPort);
