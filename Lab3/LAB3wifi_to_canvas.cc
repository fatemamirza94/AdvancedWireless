...
//  phy.Set("CcaMode1Threshold", DoubleValue(-99));
  ...
  wifi.SetRemoteStationManager ("ns3::ConstantRateWifiManager", "DataMode",StringValue ("DsssRate5_5Mbps"), "ControlMode",StringValue ("DsssRate5_5Mbps"));
 ...
 /////////////////////////////Deployment///////////////////////////// 
     ...
     positionAlloc->Add (Vector (0.0, 17.2, 1.0));
     positionAlloc->Add (Vector (10.0, 17.2, 1.0));
...
/////////////////////////////Application part///////////////////////////// 
  ...
  Ptr<Socket> recvSink2 = Socket::CreateSocket (stas.Get (3), tid2);
  InetSocketAddress local2 = InetSocketAddress (wifiInterfaces.GetAddress (3), dlPort2);
