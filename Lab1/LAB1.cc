...
NS_LOG_COMPONENT_DEFINE ("LAB1_1");
...
/////////////////////////////Devices/////////////////////////////
 ...
 /////////////////////////////Deployment/////////////////////////////
      ...
      positionAlloc->Add (Vector (251.1, 0.0, 1.0)); //251.1 for two way ground propagation model
...
/////////////////////////////PCAP tracing/////////////////////////////
  phy.EnablePcap ("LAB1_1", staDevices .Get (nWifi-1), true);
  phy.EnablePcap ("LAB1_1", staDevices .Get (0), true);
